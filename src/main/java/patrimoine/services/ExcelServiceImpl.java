...
public class ExcelServiceImpl implements ExcelService {
    ...
    @Autowired
    private MaterielPedagogiqueService materielPedagoiqueService;
    @Autowired
    private MineralogieCristallographieService mineralogieCristallographiqueService;
    @Autowired
    ...
    public void readFileExcelPedagogique() throws IOException, BiffException {
        ...
        for(int i = 3;i < sheet.getRows();i++){
            ...
            pedagogique.setAnnexe4(sheet.getCell(17,i).getContents());
            pedagogique.setAnnexe5(sheet.getCell(18,i).getContents());
            pedagogique.setAnnexe6(sheet.getCell(19,i).getContents());
            pedagogique.setAnnexe7(sheet.getCell(20,i).getContents());
            pedagogique.setAnnexe8(sheet.getCell(21,i).getContents());
            pedagogique.setAnnexe9(sheet.getCell(22,i).getContents());
            pedagogique.setAnnexe10(sheet.getCell(23,i).getContents());
            pedagogique.setAnnexe11(sheet.getCell(24,i).getContents());
            pedagogique.setAnnexe12(sheet.getCell(25,i).getContents());
            pedagogique.setAnnexe13(sheet.getCell(26,i).getContents());
            pedagogique.setAnnexe14(sheet.getCell(27,i).getContents());
            pedagogique.setAnnexe15(sheet.getCell(28,i).getContents());
            pedagogique.setAnnexe16(sheet.getCell(29,i).getContents());
            pedagogique.setAnnexe17(sheet.getCell(30,i).getContents());
            pedagogique.setAnnexe18(sheet.getCell(31,i).getContents());
            pedagogique.setAnnexe19(sheet.getCell(32,i).getContents());
            pedagogique.setAnnexe20(sheet.getCell(33,i).getContents());
            pedagogique.setAnnexe21(sheet.getCell(34,i).getContents());
            pedagogique.setAnnexe22(sheet.getCell(35,i).getContents());
            pedagogique.setAnnexe23(sheet.getCell(36,i).getContents());
            pedagogique.setAnnexe24(sheet.getCell(37,i).getContents());
            pedagogique.setAnnexe25(sheet.getCell(38,i).getContents());
            pedagogique.setAnnexe26(sheet.getCell(39,i).getContents());
            pedagogique.setAnnexe27(sheet.getCell(40,i).getContents());
            pedagogique.setAnnexe28(sheet.getCell(41,i).getContents());
            pedagogique.setAnnexe29(sheet.getCell(42,i).getContents());
            pedagogique.setAnnexe30(sheet.getCell(43,i).getContents());
            pedagogique.setAnnexe31(sheet.getCell(44,i).getContents());
            pedagogique.setAnnexe32(sheet.getCell(45,i).getContents());
            pedagogique.setAnnexe33(sheet.getCell(46,i).getContents());
            pedagogique.setAnnexe34(sheet.getCell(47,i).getContents());
            pedagogique.setAnnexe35(sheet.getCell(48,i).getContents());
            pedagogique.setAnnexe36(sheet.getCell(49,i).getContents());
            pedagogique.setAnnexe37(sheet.getCell(50,i).getContents());
            pedagogique.setAnnexe38(sheet.getCell(51,i).getContents());
            pedagogique.setAnnexe39(sheet.getCell(52,i).getContents());
            pedagogique.setAnnexe40(sheet.getCell(53,i).getContents());
    ...
    public void writeFileExcelPedagogique() throws IOException, BiffException, WriteException {
        ...
        for (Pedagogique pedagogique : pedagogiqueList) {
            ...
            this.wsheet.addCell(new Label(14, rows, pedagogique.getAnnexe1()));
            this.wsheet.addCell(new Label(15, rows, pedagogique.getAnnexe2()));
            this.wsheet.addCell(new Label(16, rows, pedagogique.getAnnexe3()));
            this.wsheet.addCell(new Label(17, rows, pedagogique.getAnnexe4()));
            this.wsheet.addCell(new Label(18, rows, pedagogique.getAnnexe5()));
            this.wsheet.addCell(new Label(19, rows, pedagogique.getAnnexe6()));
            this.wsheet.addCell(new Label(20, rows, pedagogique.getAnnexe7()));
            this.wsheet.addCell(new Label(21, rows, pedagogique.getAnnexe8()));
            this.wsheet.addCell(new Label(22, rows, pedagogique.getAnnexe9()));
            this.wsheet.addCell(new Label(23, rows, pedagogique.getAnnexe10()));
            this.wsheet.addCell(new Label(24, rows, pedagogique.getAnnexe11()));
            this.wsheet.addCell(new Label(25, rows, pedagogique.getAnnexe12()));
            this.wsheet.addCell(new Label(26, rows, pedagogique.getAnnexe13()));
            this.wsheet.addCell(new Label(27, rows, pedagogique.getAnnexe14()));
            this.wsheet.addCell(new Label(28, rows, pedagogique.getAnnexe15()));
            this.wsheet.addCell(new Label(29, rows, pedagogique.getAnnexe16()));
            this.wsheet.addCell(new Label(30, rows, pedagogique.getAnnexe17()));
            this.wsheet.addCell(new Label(31, rows, pedagogique.getAnnexe18()));
            this.wsheet.addCell(new Label(32, rows, pedagogique.getAnnexe19()));
            this.wsheet.addCell(new Label(33, rows, pedagogique.getAnnexe20()));
            this.wsheet.addCell(new Label(34, rows, pedagogique.getAnnexe21()));
            this.wsheet.addCell(new Label(35, rows, pedagogique.getAnnexe22()));
            this.wsheet.addCell(new Label(36, rows, pedagogique.getAnnexe23()));
            this.wsheet.addCell(new Label(37, rows, pedagogique.getAnnexe24()));
            this.wsheet.addCell(new Label(38, rows, pedagogique.getAnnexe25()));
            this.wsheet.addCell(new Label(39, rows, pedagogique.getAnnexe26()));
            this.wsheet.addCell(new Label(40, rows, pedagogique.getAnnexe27()));
            this.wsheet.addCell(new Label(41, rows, pedagogique.getAnnexe28()));
            this.wsheet.addCell(new Label(42, rows, pedagogique.getAnnexe29()));
            this.wsheet.addCell(new Label(43, rows, pedagogique.getAnnexe30()));
            this.wsheet.addCell(new Label(44, rows, pedagogique.getAnnexe31()));
            this.wsheet.addCell(new Label(45, rows, pedagogique.getAnnexe32()));
            this.wsheet.addCell(new Label(46, rows, pedagogique.getAnnexe33()));
            this.wsheet.addCell(new Label(47, rows, pedagogique.getAnnexe34()));
            this.wsheet.addCell(new Label(48, rows, pedagogique.getAnnexe35()));
            this.wsheet.addCell(new Label(49, rows, pedagogique.getAnnexe36()));
            this.wsheet.addCell(new Label(50, rows, pedagogique.getAnnexe37()));
            this.wsheet.addCell(new Label(51, rows, pedagogique.getAnnexe38()));
            this.wsheet.addCell(new Label(52, rows, pedagogique.getAnnexe39()));
            this.wsheet.addCell(new Label(53, rows, pedagogique.getAnnexe40()));
            rows++;
        }
    }
